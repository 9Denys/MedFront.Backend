...
namespace MedFront.Backend.Application.Services.User.Commands
{
    ...
    public class UpdateUserCommandHandler : IRequestHandler<UpdateUserCommand>
    {
        ...
        public UpdateUserCommandHandler(IMedFrontDbContext context, IUserContextService userContextService)
        {
            _context = context;
